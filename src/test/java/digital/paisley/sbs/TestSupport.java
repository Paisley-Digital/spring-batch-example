...
public class TestSupport extends Assert {
    ...
    protected Orders getStoreOrder(Long id) {
        return Orders.builder().id(id).productName("Product Name 1").build();
    }

    protected List<Orders> getListDummies() {
        List<Orders> orders = new ArrayList<>();
        orders.add(getStoreOrder(0L));
        return orders;
    }
